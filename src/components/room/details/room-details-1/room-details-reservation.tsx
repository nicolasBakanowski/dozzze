...
export default function RoomDetailsReservation({ hotelId }: { hotelId: string }) {
    ...
    // Determine if the button should be disabled
    const bookingUnavailable = Boolean(state?.data?.isBooked && !hasFormChanges);
    const isDisabled = !checkin || !checkout || pending || bookingUnavailable;
    ...
    return (
        <div className="tp-room-details-info-wrap box-bg mb-35">
            <h3 className="tp-room-details-info-title mb-25">Reservation Form</h3>
            <form className="reservation-form" action={formAction} onSubmit={handleFormSubmit}>
                <p className="">
                    <small>
                        Required fields are followed by <abbr title="required">*</abbr>
                    </small>
                ...
                <p className="">
                    ...
                    <br />
                    <DatePicker date={checkin} setDate={handleCheckinChange} />
                </p>
                ...
                <p>
                    ...
                    <br />
                    <DatePicker date={checkout} setDate={handleCheckoutChange} minDate={getNextDay(checkin)} />
                </p>

                <GuestSelector adultGuests={adultGuests} childGuests={childGuests} setAdultGuests={handleAdultChange} setChildGuests={handleChildChange} topCls="details-reservation" />

                <div className="tp-purches-btn mt-20">
                    <button type="submit" disabled={isDisabled} className="tp-btn-falured">
                        {bookingUnavailable ? "Unavailable" : "Book Now"}
                    </button>
                </div>
